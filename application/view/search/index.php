...
<div id="index">
	<div id="header">
		...
		<div class="nav">
			<ul id="logonav">
				...
				<li id="nv-search">
				<a style="border-bottom: 4px solid #09f;color:#09f;">
	...
	<div id="content">
      <div style="width:100%;">
       查找：<?php echo $this->values["searchtext"]; ?>的结果：
      <hr>
      </div>
      <div style="margin:10px;">
        <div>与<?php echo $this->values["searchtext"]; ?>相关的用户：</div></br>
  	    <?php echo $this->values["searchuser"]; ?>
      </div>
      <div style="width:100%;margin:10px;">
          <div>与<?php echo $this->values["searchtext"]; ?>相关的标签：</div></br>
         <?php echo $this->values["searchtag"]; ?>
      </div>
        <div style="width:100%;margin:10px;">
          <div>与<?php echo $this->values["searchtext"]; ?>相关的画集：</div></br>
         <?php echo $this->values["searchgroup"]; ?>
      </div>
      </div>
	<div id="footer">
