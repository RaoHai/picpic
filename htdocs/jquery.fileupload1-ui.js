...
(function (factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        define(['jquery', 'tmpl', 'loadImage', './jquery.fileupload1.js'], factory);
    } else {
        // Browser globals:
    ...
    // The UI version extends the basic fileupload11 widget and adds
    // a complete user interface based on the given upload/download
    // templates.
    $.widget('blueimpUI.fileupload1', $.blueimp.fileupload1, {
        ...
        options: {
            ...
            add: function (e, data) {
                var that = $(this).data('fileupload1'),
                    files = data.files;
        ...
        _deleteHandler: function (e) {
            e.preventDefault();
            var button = $(this);
            e.data.fileupload1._trigger('destroy', e, {
                context: button.closest('.template-download'),
                url: button.attr('data-url'),
                type: button.attr('data-type'),
                dataType: e.data.fileupload1.options.dataType
            });
        },
        ...
        _initButtonBarEventHandlers: function () {
            var fileupload1ButtonBar = this.element.find('.fileupload1-buttonbar'),
                filesList = this._files,
                ns = this.options.namespace;
            fileupload1ButtonBar.find('.start')
                .bind('click.' + ns, function (e) {
                    e.preventDefault();
                    filesList.find('.start button').click();
                });
            fileupload1ButtonBar.find('.cancel')
                .bind('click.' + ns, function (e) {
                    e.preventDefault();
                    filesList.find('.cancel button').click();
                });
            fileupload1ButtonBar.find('.delete')
                .bind('click.' + ns, function (e) {
                    e.preventDefault();
                    filesList.find('.delete input:checked')
                        .siblings('button').click();
                });
            fileupload1ButtonBar.find('.toggle')
        ...
        _destroyButtonBarEventHandlers: function () {
            this.element.find('.fileupload1-buttonbar button')
                .unbind('click.' + this.options.namespace);
            this.element.find('.fileupload1-buttonbar .toggle')
                .unbind('change.' + this.options.namespace);
        },

        _initEventHandlers: function () {
            $.blueimp.fileupload1.prototype._initEventHandlers.call(this);
            var eventData = {fileupload1: this};
            this._files
                .delegate(
                    '.start button',
        ...
        _destroyEventHandlers: function () {
            ...
            $.blueimp.fileupload1.prototype._destroyEventHandlers.call(this);
        },
        ...
        _create: function () {
            this._initFiles();
            $.blueimp.fileupload1.prototype._create.call(this);
            this._initTemplates();
        },

        destroy: function () {
            $.blueimp.fileupload1.prototype.destroy.call(this);
        },

        enable: function () {
            $.blueimp.fileupload1.prototype.enable.call(this);
        ...
        disable: function () {
            ...
            this._disableFileInputButton();
            $.blueimp.fileupload1.prototype.disable.call(this);
        }
