...
(function ($) {
    ...
    $.widget('blueimp.imagegallery', {
        ...
        _initModal: function () {
            ...
            this._modalId.val(this._currentLink.id);
            $('#edimgdesc').val(this._currentLink.name);
		        //console.log($(this._currentLink).attr('tags'));
            $('#tags_1').importTags($(this._currentLink).attr('tags'));
                       
            	$.ajax({                                                
			type: "get",                                 
			url: "/image/wholike/"+this._currentLink.id,                                    
       ...
       $('#favored').html(msg);   
        ...
        _create: function () {
            ...
            this._modalImg	= this._modal.find('.modal-header .imgname');
		        this._modalTag  = this._modal.find('.imgtags');
            this._modalId   = this._modal.find('.imgid');
