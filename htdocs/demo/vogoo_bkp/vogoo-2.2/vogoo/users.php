...
EOF;
        ...
        /* To get $k similar users whos tastes are similar to 4member_id*/ 
	function member_k_similarities($member_id,$k,&$similarities,$cat = 1)
	{
		...
		$similarities = array();
		/* this function returns the number of  products rated by this member */
...
EOF;
  // THE ABOVE QUERY RETURNS rows which have the r1.member id as $member_id and only those products which $member_id has brought and where r2_mem 1 r1.mem
