...
<div style="width:600px;margin:0 auto;padding-top:50px;">
	<div>
		<h3 style="font-size:16px;padding:5px;border-bottom:solid 1px #ccc;">请选择图片</h3>
		...
		//保存缩略图的地址.
		var saveUrl = '/information/upload/save_avatar.php';
		//保存摄象头白摄图片的地址.
		var cameraPostUrl = '/information/upload/camera.php';
		//头像编辑器flash的地址.
		var editorFlaPath = '/information/upload/AvatarEditor.swf';
		...
		function buildAvatarEditor(pic_id,pic_path,post_type)
		{
			...
			function avatarSaved(){
				alert('保存成功.');
				window.location.href = '/information/user.php';
			}
